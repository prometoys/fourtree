...
/**
* Class for SyntaxTree questions
*
* SyntaxTree is a class for SyntaxTree questions. To solve a SyntaxTree
* question, a learner has to enter one or more SyntaxTree in labelled 
* brakcet notation.
*
...
*/
class SyntaxTree extends assQuestion
{
	/**
	...
	*/
	...
	/**
	* Returns true, if a SyntaxTree question is complete for use
	*
	* Returns true, if a SyntaxTree question is complete for use
	*
	* @return boolean True, if the SyntaxTree question is complete for use, otherwise false
	* @access public
	*/
	function isComplete()
	{
	...
	*/
	...
	/**
	* Duplicates an SyntaxTreeQuestion
	*
	* Duplicates an SyntaxTreeQuestion
	*
	* @access public
	...
	* Returns the number of answers
	*
	* @return integer The number of answers of the SyntaxTree question
	* @access public
	* @see $ranges
	*/
	...
	*/
	function isAnswerCorrect($answers, $answer)
	{
		...
		//Make more robust to different whitespaces
